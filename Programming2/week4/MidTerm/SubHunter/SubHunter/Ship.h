...
public:
    ...
    void setLocation(MyPoint pointIn) {
        location = pointIn;
    }
    void decrementAmmo() {
        if (ammo > 0) {
    ...
    MyPoint moveFwd(Direction d, MyPoint l) {
        int x, y;
        switch (d) {
            case North:
                x = l.getRow();
    ...
    MyPoint patrolFwd(Direction d, MyPoint l) {
        int x, y;
        switch (d) {
            case North:
                x = l.getRow();
                ...
                if (x > 2) {
                    ...
                    this->turn(d, Left); //if hit wall turn left...need then move
                }
                return l;
                break;
            case East:
